                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="coffee" value="Yes" class="custom-control-input" id="customCheck1">
                                            <label class="custom-control-label" for="customCheck1">Coffee</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="snacks" value="Yes" class="custom-control-input" id="customCheck2">
